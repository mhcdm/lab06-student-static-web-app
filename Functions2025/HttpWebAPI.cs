...
[HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "students")] HttpRequestData req)
    ...
    public HttpResponseData GetStudentBySchool
    (
    ...
    )
    {
        ...
        response3.Headers.Add("Content-Type", "application/json");
        response3.WriteStringAsync(JsonConvert.SerializeObject(students));
        return response3;
    }
    ...
    )
    {
        ...
        .ToList();
        if (studentCounts == null || studentCounts.Count == 0)
        {
            var response = req.CreateResponse(HttpStatusCode.NotFound);
            response.Headers.Add("Content-Type", "application/json");
            response.WriteStringAsync("Not Found");
        ...
        var response3 = req.CreateResponse(HttpStatusCode.OK);
        response3.Headers.Add("Content-Type", "application/json");
        response3.WriteStringAsync(JsonConvert.SerializeObject(studentCounts));
        return response3;
    }
